...
con1=m.connect(host='localhost',port=3309,user='root',passwd='root')
...
con=m.connect(host='localhost',port=3309,user='root',passwd='root',database='The_Student')
    ...
    def register_DB():
            def verify():
                if(OTP1 == E2.get()):
                    ...
                    mb.showinf("Invalid OTP","Check your OTP again")
                    print("Check your OTP again")

            OTP1=str(random.randint(1000,9999))
            
            s=smtplib.SMTP_SSL("smtp.gmail.com",465)
            s.login('minehope16@gmail.com',"wwmawlakygdcnejw")
            send_to=e5.get()
            msgg=f"The OPT for Student registeration is {OTP1} \n\nThanks for choosing us."
            s.sendmail('minehope16@gmail.com',send_to,msgg)
